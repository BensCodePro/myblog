  ...
  $row = query($query, ['email'=>$_POST['email']]);
    ...
    if($row)
    {
      ...
      redirect('admin');
        ...
        $errors['email'] = "Correo o contraseña equivocada";
      }
...
<main class="form-signin w-100 m-auto">
  ...
  <a href="home">
    ...
    <div class="my-2"> ¿No tienes una cuenta?<a href="<?= ROOT ?>/signup">Registrate aquí</a></div>
    <div class="checkbox mb-3">
      <label>
        <input name="remember" type="checkbox" value="1"> Recuerdame
      </label>
    </div>
