...
<main class="form-signin w-100 m-auto">
  ...
  <form method="post">
    ...
    <div class="my-2">¿Ya tienes una cuenta? <a href="<?=ROOT?>/login">Loguea aquí</a></div>

    <div class="checkbox mb-3">
      <label>
        <input <?=old_checked('terms')?> name="terms" type="checkbox" value="remember-me"> Aceptar  los terminos y condiciones
      </label>
    </div>
